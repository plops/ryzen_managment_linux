 ...
 * into a render-ready format (calculating trimmed means). This avoids doing heavy
...
public:
     ...
     * It locks the eye_storage, calculates trimmed means, and updates its internal cache.
