...
/**
 * @class PmTableReader
 * @brief Simple helper that reads the kernel pm_table sysfs blob and reports
 * its size.
 *
 * The class opens /sys/kernel/ryzen_smu_drv/pm_table and reads pm_table_size
 * bytes on demand.
 */
class PmTableReader {
public:
   ...
   * @return Size in bytes as reported by
